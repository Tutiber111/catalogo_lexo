(function () {
  ...
  async function saveGuestOrder(order, sessionToken) {
    return callCatalogGuestAccess({
      ...
      delivery_address: order.customer.deliveryAddress ?? order.customer.salesClient?.address ?? "",
  ...
  async function saveOrder(order, userId, options = {}) {
    ...
    const orderPayload = {
      ...
      sales_client_address: order.customer.deliveryAddress ?? order.customer.salesClient?.address ?? "",
  ...
  function normalizeOrder(order) {
    return {
      ...
      customer: {
        ...
        deliveryAddress: order.sales_client_address || "",
